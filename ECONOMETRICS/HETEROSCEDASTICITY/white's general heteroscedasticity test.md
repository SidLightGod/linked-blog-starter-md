...
4. if the chi square value obtained from the regression is larger than the chi square critical value at the chosen level of significance or if the p value of the computed chi square value is reasonably low, we can reject the null hypothesis of no heteroscedasticity 