...
-  $rB_{t-1}$ equals the real interest payments on the government debt in the year t. 
-  $G_t$ is the government spending on goods and services during year t. 
-  $T_t$ is taxes minus transfers during the year t. (the total tax revenues)

> this implies the budget deficit equals spending, including interest payments on the debt, minus taxes of transfers. 
...
- we can separate the deficit into sum of two terms :
	...
	- and the difference between the spending and taxes, this term is called primary deficit. 
